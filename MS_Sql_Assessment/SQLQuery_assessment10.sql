...
insert into UserDetails values(5,'Chandru','sekar','chandru@gmail.com','chengalpattu',21500,'tester','2022-05-02 10:11','2022-09-10 01:45',1);
insert into UserDetails values(6,'Vishnu','vishal','vishnu@gmail.com','chennai',51500,'support','2019-12-02 10:11','2022-10-10 01:45',1);
...
insert into UserDetails values(10,'Janavi','priya','janavi@gmail.com','vellore',61500,'support','2018-01-02 10:11','2020-09-10 01:45',1);
insert into UserDetails values(8,'Arun','n','arun@gmail.com','chennai',21500,'tester','2022-12-02 10:11','2023-09-10 01:45',1);
insert into UserDetails values(9,'ajay','k','karthi@gmail.com','chennai',21500,'developer','2022-12-02 10:11','2023-09-10 01:45',1);
insert into UserDetails values(11,'priya','mani','priya@gmail.com','vellore',61500,'support','2018-01-02 10:11','2020-09-10 01:45',1);
...
create procedure spgetuserbydesignation
@Designation varchar(30)
as
begin
select UserDetails.* from UserDetails where Designation=@Designation
end

spgetuserbydesignation 'developer'

create procedure spgetuserbyCreatedDaate
@CreatedDate datetime
as
begin
select UserDetails.* from UserDetails where CreatedDate =@CreatedDate 
end

spgetuserbyCreatedDaate '2022-05-02 10:11'

create procedure spgetuserbydepartment
as
begin
...
spgetuserbydepartment

create procedure spgetuserbydepartmentandDate
as
begin
select userDetails.FirstName, Grouptable.Id,grouptable.Names from  UserDetails  join UserGroupTable on   UserDetails.ID =UserGroupTable.UserId 
