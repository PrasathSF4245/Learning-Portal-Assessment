...
select * from UserDetails where FirstName like 'a%' order by createddate desc;

select firstname, email from UserDetails where ModifiedDate>'2020-12-02';

select * from GroupTable where Descriptions is null order by Names;